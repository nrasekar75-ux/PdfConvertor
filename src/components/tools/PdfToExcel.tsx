...
import { pdfToExcel, downloadBlob } from '../../services/pdfService';
...
export function PdfToExcel() {
  ...
  return (
    <ToolLayout
      ...
      toolDescription="Extract data from PDF tables to Excel spreadsheets"
    >
        ...
        <div className="bg-white rounded-lg p-8 shadow-md">
          ...
          <ul className="space-y-3 text-gray-600">
            <li className="flex space-x-3">
              ...
              <span>Extract tables from PDF to Excel</span>
            </li>
            <li className="flex space-x-3">
              <span className="text-blue-600">✓</span>
              <span>Convert to CSV format</span>
            </li>
            <li className="flex space-x-3">
              <span className="text-blue-600">✓</span>
              <span>Preserve data structure</span>
            </li>
            <li className="flex space-x-3">
              <span className="text-blue-600">✓</span>
